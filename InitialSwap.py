...
CityPlace = Addr("6ZHGHH5Z5CTPCF5WCESXMGRSVK7QJETR63M3NY5FJCUYDHO57VTCMJOBGY")
InvestorPerson = Addr("7Z5PWO2C6LFNQFGHWKSK5H47IQP5OJW2M3HA2QPXTY3WTNP5NU2MHBW27M")
secret = Bytes("base32", "2323232323232323")
timeout = 3000

# How do i intrigate an oracle price check into this. Want to say 100 USDC and convert to algo. 


def htlc(
    tmpl_seller=CityPlace,
    tmpl_buyer=InvestorPerson,
    tmpl_fee=1000,
    tmpl_secret=secret,
    tmpl_hash_fn=Sha256,
